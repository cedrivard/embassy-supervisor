...
// the work and, mid-run, detaches the node so its teardown won't cascade into `net`.
#[embassy_executor::task]
pub(crate) async fn ota_task(_node: &'static TaskNode) {
